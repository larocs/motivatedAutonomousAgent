...
/**
 * @file iCubSimInteractionModule.h
 * @brief Definition of a module.
 */

#ifndef _ICUBSIMINTERACTION_MODULE_H_
#define _ICUBSIMINTERACTION_MODULE_H_
...
class iCubSimInteractionModule:public yarp::os::RFModule {
    ...
    /*  */
    iCubSimInteractionThread *pThread;             // pointer to a new thread to be created and started in configure() and stopped in close()
...
#endif // _ICUBSIMINTERACTION_MODULE_H_
