 ...
 * @brief Definition of a module that detects the segmented objects in the scene.
 */

#ifndef _PERCEPTION_MODULE_H_
#define _PERCEPTION_MODULE_H_
...
class perceptionModule:public yarp::os::RFModule {
    ...
    /*  */
    perceptionThread *pThread;             // pointer to a new thread to be created and started in configure() and stopped in close()
