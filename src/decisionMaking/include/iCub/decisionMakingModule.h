...
/**
 * @file decisionMakingModule.h
 * @brief Definition of a module.
 */

#ifndef _DECISIONMAKING_MODULE_H_
#define _DECISIONMAKING_MODULE_H_
...
class decisionMakingModule:public yarp::os::RFModule {
    ...
    /*  */
    decisionMakingThread *pThread;             // pointer to a new thread to be created and started in configure() and stopped in close()
...
#endif // _DECISIONMAKING_MODULE_H__
