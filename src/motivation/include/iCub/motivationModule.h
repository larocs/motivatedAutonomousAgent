...
/**
 * @file motivationModule.h
 * @brief Definition of a module.
 */

#ifndef _MOTIVATION_MODULE_H_
#define _MOTIVATION_MODULE_H_
...
class motivationModule:public yarp::os::RFModule {
    ...
    /*  */
    motivationThread *pThread;             // pointer to a new thread to be created and started in configure() and stopped in close()
