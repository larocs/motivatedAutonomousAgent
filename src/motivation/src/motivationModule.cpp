...
/**
 * @file motivationModule.cpp
 * @brief Implementation of the motivationModule (see header file).
 */
...
bool motivationModule::configure(yarp::os::ResourceFinder &rf) {
    ...
    */
    ...
    pThread = new motivationThread(robotName, rf, robot_color, robot_profile);
...
bool motivationModule::interruptModule() {
    handlerPort.interrupt();
    return true;
}

bool motivationModule::close() {
    handlerPort.close();
    /* stop the thread */
...
bool motivationModule::respond(const Bottle& command, Bottle& reply) 
{
...
bool motivationModule::updateModule()
{
    return true;
}

double motivationModule::getPeriod()
{
