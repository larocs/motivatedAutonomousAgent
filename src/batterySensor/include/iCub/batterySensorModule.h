...
/**
 * @file batterySensorModule.h
 * @brief Definition of a module.
 */

#ifndef _BATTERYSENSOR_MODULE_H_
#define _BATTERYSENSOR_MODULE_H_
...
class batterySensorModule:public yarp::os::RFModule {
    ...
    /*  */
    batterySensorThread *pThread;             // pointer to a new thread to be created and started in configure() and stopped in close()
...
#endif // _BATTERYSENSOR_MODULE_H__
