...
/**
 * @file iCubeProcessorModule.h
 * @brief Definition of a module.
 */

#ifndef _ICUBEPROCESSOR_MODULE_H_
#define _ICUBEPROCESSOR_MODULE_H_
...
class iCubeProcessorModule:public yarp::os::RFModule {
    ...
    /*  */
    iCubeProcessorThread *pThread;             // pointer to a new thread to be created and started in configure() and stopped in close()
